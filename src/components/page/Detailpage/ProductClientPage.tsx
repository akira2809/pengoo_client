...
const ProductImageGallery = dynamic(
  () =>
    import("@/components/layouts/ProductDetail/ProductImageGallery").then(
      (mod) => mod.default
    ),
  {
    loading: () => (
...
const ProductDetailsSection = dynamic(
  () =>
    import("@/components/layouts/ProductDetail/ProductDetailsSection").then(
      (mod) => mod.default
    ),
  {
    loading: () => (
...
const ProductBanner = dynamic(
  () =>
    import("@/components/layouts/ProductDetail/component/ProductBanner").then(
      (mod) => mod.default
    ),
  {
    loading: () => (
      <div className="w-full h-[200px] bg-gray-100 animate-pulse my-8" />
    ),
    ssr: false,
  }
);
...
const ProductTabs = dynamic(
  () =>
    import("@/components/layouts/ProductDetail/component/ProductTabs").then(
      (mod) => mod.default
    ),
  {
    loading: () => (
      <div className="w-full h-[300px] bg-gray-100 animate-pulse my-8" />
    ),
    ssr: false,
  }
);
...
const FeaturedSection = dynamic(
  () =>
    import("@/components/layouts/ProductDetail/component/FeaturedSection").then(
      (mod) => mod.default
    ),
  {
    loading: () => (
      <div className="w-full h-[600px] bg-gray-100 animate-pulse my-8" />
    ),
    ssr: false,
  }
);
...
const BlogSection = dynamic(
  ...
  {
    loading: () => (
      <div className="w-full h-[400px] w-full my-8 bg-gray-100 animate-pulse"></div>
    ),
    ssr: false,
  }
);
...
const ProductsYouMayLike = dynamic(
  () =>
    import("@/components/layouts/ProductDetail/ProductsYouMayLike").then(
      (mod) => mod.default
    ),
  { ssr: false }
);
...
const ProductClientPage: React.FC<ProductClientPageProps> = ({
  ...
  mainIntro = {
    ...
    description: "Khám phá những điểm đặc biệt của sản phẩm",
  },
}) => {
  ...
  return (
    <div className="container mx-auto px-4">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex flex-col md:flex-row">
        ...
        <div className="w-full md:w-1/2 md:pl-8">
          <ProductDetailsSection
            ...
            quantity_stock={
              typeof product.quantity_stock === "number"
      ...
      <ProductsYouMayLike
        ...
        categoryId={
          typeof product.category_ID === "object"
            ? (product.category_ID.id as number)
            : undefined
        }
        tagIds={
          Array.isArray(product.tags)
            ? product.tags.map((tag) =>
                typeof tag.id === "string" ? Number(tag.id) : tag.id
              )
            : undefined
        }
      />
