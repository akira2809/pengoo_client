...
const PolicyBanner: React.FC<PolicyBannerProps> = ({title}) => {
  return (
    <div className="relative w-full h-[20vw] md:h-[15vw] flex items-center justify-center overflow-hidden">

      {/* Overlay (tùy chọn, để làm mờ ảnh nền và làm nổi bật chữ hơn) */}
      <div className="absolute inset-0 z-10"></div>

      {/* Content */}
      <div className="relative z-20 text-black text-center px-3">
        <h1
