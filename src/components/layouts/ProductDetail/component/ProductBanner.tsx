...
export default function ProductBanner({ title, subtitle, images }: { title?: string; subtitle?: string; images?: string[] }) {
        ...
        <div className="fixed inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center p-4">
          ...
          >
            ...
            <Dialog.Description className="text-gray-600 mb-4">
              {subtitle || "Một bộ bài siêu thú vị để bạn chill cùng bạn bè!"}
            </Dialog.Description>
            <button
